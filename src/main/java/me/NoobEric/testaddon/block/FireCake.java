...
//        item.register(this);
        SlimefunItemStack itemStack = new SlimefunItemStack("FIRE_CAKE", Material.CAKE,"Fire Cake","","Oops");
...
//        event.cancel();
        ...
        if(player.getSaturation()>=20)return;
        player.setFireTicks(5*20);
        player.sendMessage(ChatColor.GOLD+"锟斤拷烫烫烫"+player.getSaturation());
    }
}
